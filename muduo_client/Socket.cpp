...
void Socket::setKeepAlive(bool on)
{
  ...
  LOG_DEBUG << "wb+++ " << setsockopt(m_sockfd, IPPROTO_TCP, TCP_KEEPIDLE, (void*)&keepidle , sizeof(keepidle ));
  LOG_DEBUG << "wb+++ " << setsockopt(m_sockfd, IPPROTO_TCP, TCP_KEEPINTVL, (void *)&keepinterval , sizeof(keepinterval ));
  LOG_DEBUG << "wb+++ " << setsockopt(m_sockfd, IPPROTO_TCP, TCP_KEEPCNT, (void *)&keepcount , sizeof(keepcount ));
